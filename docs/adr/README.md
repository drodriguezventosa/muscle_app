...
| [0004](0004-provider-agnostic-llm.md) | Provider-agnostic LLM (ports & adapters) | partially superseded by 0019 |
| [0005](0005-frontend-vue-vite-pinia.md) | Vue 3 + Vite + TypeScript + Pinia frontend | accepted |
| [0006](0006-public-no-login-mvp.md) | Public, no-login MVP; auth/monetization deferred | partially superseded by 0021 |
...
| [0010](0010-cost-zero-tooling-and-deploy.md) | Cost-zero tooling and deployment | partially superseded by 0019 |
| [0011](0011-client-side-workout-progress.md) | Client-side workout progress (localStorage) | accepted |
| [0012](0012-trainers-preview-mockup.md) | Trainers/coaching as a frontend preview mockup | superseded by 0021, 0024, 0026 |
| [0013](0013-light-dark-theme.md) | Light/dark theme via CSS token overrides | accepted |
| [0014](0014-continuous-deployment.md) | Continuous deployment on merge to main | partially superseded by 0019 |
