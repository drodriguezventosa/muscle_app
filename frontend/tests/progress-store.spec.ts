...
describe('progress store', () => {
  ...
  it('records sessions and tracks last and best', () => {
    ...
    s.log(1, 'Squat', 60, true, 8, '2026-07-01')
    s.log(1, 'Squat', 65, true, 8, '2026-07-08')
  ...
  it('persists to localStorage across store instances', () => {
    useProgressStore().log(2, 'Bench', 40, true, 10, '2026-07-02')
  ...
  it('flattens every session for the server, defaulting missing reps', () => {
    const s = useProgressStore()
    s.log(1, 'Squat', 60, true, 8, '2026-07-01')
    s.log(2, 'Bench', 40, false, undefined, '2026-07-02')

    expect(s.pending()).toEqual([
      { exerciseId: 1, loggedOn: '2026-07-01', weightKg: 60, reps: 8, completed: true },
      { exerciseId: 2, loggedOn: '2026-07-02', weightKg: 40, reps: 0, completed: false },
    ])
  })
})
