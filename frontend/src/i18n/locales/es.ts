export default {
  ...
  plan: {
    ...
    noPlan: '{name} aún no te ha programado nada para esta semana.',
    byTrainer: 'Lo programa {name}.',
    restDay: 'Descanso',
  ...
  trainers: {
    ...
    perMonth: '/mes',
    hire: 'Contratar',
    switch: 'Cambiar a este',
    yourTrainer: 'Tu entrenador es {name}.',
    goToPlan: 'Ver mi plan',
    loading: 'Cargando entrenadores…',
    error: 'No se han podido cargar los entrenadores.',
    studentsCount: '{n} alumno | {n} alumnos',
    active: 'Activo',
